  ...
  "Movie Title 10"
    ...
    if (result) {
      const cleanResults = result
        ...
        .replace(/\n```/i, "");
      try {
        const recommendationArray = JSON.parse(cleanResults);
          ...
          <div className="w-full flex flex-col flex-1">
              ...
              <div className="grid grid-cols-1 gap-3">
                {steps[step].options.map((option) => (
                  <button
                    ...
                    className={`w-full py-3 rounded-xl border-2 transition font-semibold text-base flex items-center justify-center gap-2 text-white shadow-sm focus:outline-none focus:ring-2 active:scale-95 duration-150 focus:ring-[#e50914] ${
                      inputs[steps[step].name] == option
                        ? "bg-[#e50914] border-[#e50914] shadow-lg"
                        : "bg-[#232323] border-[#444] hover:bg-[#e50914]/80 hover:border-[#e50914]"
                    }`}
                  >
                    {option}
                  </button>
            ...
            <div className="flex justify-between items-center mt-6">
              ...
              <button
                ...
                className="px-6 py-2 rounded-lg font-semibold transition border-2 border-transparent text-white bg-[#e50914] hover:bg-[#b0060f]"
              >
